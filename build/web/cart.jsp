<%-- 
    Document   : cart
    Created on : Jul 11, 2020, 11:36:31 AM
    Author     : se130
--%>
       ...
       <%@include file="header.jsp" %>
        <div class="container mt-lg-4" id="content">
            <h2>Your shopping cart</h2>
                ...
                <c:if test="${not empty requestScope.CART}" var="NoOrder">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 2%; text-align: center;">Total</th>
                            <th style="width: 5%; text-align: center;">Delete</th>
                            <th style="width: 25%; text-align: center;">Update</th>
